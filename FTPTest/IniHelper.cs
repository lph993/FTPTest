...
namespace FTPTest
{
    public class IniHelper
    {
        ...
        public static string Read(string section, string key, string def)
        {
            ...
            GetPrivateProfileString(section, key, def, sb, 1024, Application.StartupPath+"\\app.ini");
            return sb.ToString();
        }
        ...
        {
            return WritePrivateProfileString(section, key, value,Application.StartupPath+"\\app.ini");
        }
